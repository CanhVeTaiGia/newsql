...
begin
	select
    sum(a.Balance) into TotalBalance
    from customers c
    join accounts a
...
-- 4
delimiter &&
create procedure IncreaseEmployeeSalary(out CurrentSalary decimal(10, 2), EmployeeID int)
begin
	update employees e
...
call IncreaseEmployeeSalary(@CurrentSalary, 4);
